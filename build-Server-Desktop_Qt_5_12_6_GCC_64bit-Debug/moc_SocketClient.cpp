...
QT_MOC_LITERAL(1, 13, 12), // "ReadyReadSig"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 13), // "SocketClient*"
QT_MOC_LITERAL(4, 41, 15), // "StateChangedSig"
QT_MOC_LITERAL(5, 57, 11), // "emitReadSig"
QT_MOC_LITERAL(6, 69, 14), // "emitChangedSig"
QT_MOC_LITERAL(7, 84, 1) // "S"

    },
    "SocketClient\0ReadyReadSig\0\0SocketClient*\0"
    "StateChangedSig\0emitReadSig\0emitChangedSig\0"
    "S"
};
...
void SocketClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ReadyReadSig((*reinterpret_cast< SocketClient*(*)>(_a[1]))); break;
        case 1: _t->StateChangedSig((*reinterpret_cast< SocketClient*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->emitReadSig(); break;
        case 3: _t->emitChangedSig((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (SocketClient::*)(SocketClient * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketClient::ReadyReadSig)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SocketClient::*)(SocketClient * , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketClient::StateChangedSig)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SocketClient::ReadyReadSig(SocketClient * _t1)
{
...
// SIGNAL 1
void SocketClient::StateChangedSig(SocketClient * _t1, int _t2)
{
